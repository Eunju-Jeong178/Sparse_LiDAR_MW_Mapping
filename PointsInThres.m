...
function [pointsIdxInThres] = PointsInThres(pointCloud, walls, TH_DISTANCE_BETWEEN_REFITTED_LINE, TH_DISTANCE_BETWEEN_ENDPOINT) 
...
%         pointsIdxSameWall = PointsInThres(pointsIdxSameWall);
%     end
end
