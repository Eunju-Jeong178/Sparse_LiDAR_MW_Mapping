...
%     %% 1) draw moving trajectory
    ...
    plot3(fourPoint_xyz(1,:), fourPoint_xyz(2,:), fourPoint_xyz(3,:), '.'); hold on; % LiDAR 1
    plot3(fourPoint_xyz(4,:), fourPoint_xyz(5,:), fourPoint_xyz(6,:), '.'); hold on; % LiDAR 2
    plot3(fourPoint_xyz(7,:), fourPoint_xyz(8,:), fourPoint_xyz(9,:), '.'); hold on; % LiDAR 3
    %plot3(fourPoint_xyz(10,:), fourPoint_xyz(11,:), fourPoint_xyz(12,:), '.'); hold on; % LiDAR 4
    axis equal; hold on;
...
%     pointCloud_original = [pointCloud_xyz(1:imgIdx,1:3);pointCloud_xyz(1:imgIdx,4:6)]';
    ...
    for i = 1 : num_current_points
        plot3(current_points(i).x, current_points(i).y, current_points(i).z, 'r*');
    end
...
%     plot_plane; view(47, 48);
    ...
    plot(p_gc(1,:), p_gc(2,:), 'm', 'LineWidth', 2);
