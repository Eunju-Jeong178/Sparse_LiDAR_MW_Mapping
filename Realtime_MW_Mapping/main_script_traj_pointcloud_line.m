...
MAX_DISTANCE_RANSAC = 0.05; % max allowable distance for inliers (positive scalar)

%% 3) Plot trajectory, point cloud, line (moving)
...
for k = 1:numPose_optitrack
    ...
    %% 3-1) draw moving trajectory (optitrack)
    ...
    %% 3-2) draw 6 direction point cloud: Optitrack
    ...
    %% 3-3) MW_mapping (Application of ICCAS 2022)
...
%% 4) Plot Results (trajectory and point cloud)
